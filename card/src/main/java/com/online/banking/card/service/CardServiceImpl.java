...
import com.online.banking.card.util.UUIDGenerator;
...
//        validationUtil.validateCardRequest(cardRequestDto);
        ...
        card.setCardNumber(UUIDGenerator.generateUniqueAccountNumber());
        card.setStakeholderName(cardRequestDto.getStakeholderName());
        card.setAccountId(cardRequestDto.getAccountId());
        card.setCvv("123");
