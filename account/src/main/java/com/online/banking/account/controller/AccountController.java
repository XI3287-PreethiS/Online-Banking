...
public class AccountController {
    ...
    public ResponseEntity<AccountResponseDto> addFund(@RequestParam String accountNumber, @RequestParam BigDecimal amount) {
        return ResponseEntity.ok(accountService.addFund(accountNumber, amount));
    }

    @PostMapping("/withdraw-amount")
    public ResponseEntity<AccountResponseDto> withdrawAmount(@RequestParam String accountNumber, @RequestParam BigDecimal amount) {
        return ResponseEntity.ok(accountService.withdrawAmount(accountNumber, amount));
    }

    @GetMapping("/balance/{accountNumber}")
    public ResponseEntity<AccountResponseDto> getAccountBalance(@PathVariable String accountNumber) {
        AccountResponseDto balanceResponse = accountService.getAccountBalance(accountNumber);
